...
-- 9. Personal/Business mode + receipt scan PDF
ALTER TABLE bank_transactions ADD COLUMN is_personal boolean DEFAULT false;
ALTER TABLE receipts          ADD COLUMN is_personal boolean DEFAULT false;
ALTER TABLE revenue_entries   ADD COLUMN is_personal boolean DEFAULT false;
ALTER TABLE receipts          ADD COLUMN scan_pdf_url text;

CREATE INDEX idx_bank_transactions_is_personal ON bank_transactions(is_personal);
