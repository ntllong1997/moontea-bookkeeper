...
import LogoutButton from '@/components/bookkeeper/LogoutButton';
...
export default function BookkeeperPage() {
    ...
    const fetchSummary = useCallback(async () => {
        setLoading(true);
        try {
            const res = await fetch(`/api/bookkeeper/summary?mode=${mode}`);
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="rounded-xl border p-2 text-gray-500 hover:bg-gray-100 disabled:opacity-50"
                        >
                            <RefreshCw
                                size={16}
